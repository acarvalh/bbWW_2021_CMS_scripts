...
--fitdiag_folder /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/fitdiag2  \
--output_dict /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/plots2/dict_SL.dat \
--only_sig

/afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/plots/dict_DL.dat

python dhi/scripts/postfit_plots.py \
--output_folder /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/plots2/SL/ \
--plot_options_dict /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/plots2/dict_SL.dat
...
fitDiagnostics_shapes_combine_sl_2018_all_boosted_sr_dnn_node_H.root
fitDiagnostics_shapes_combine_sl_2018_all_boosted_1b_sr_dnn_node_H.root

rm /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/fitdiag2/fitDiagnostics_shapes_combine_hadd_sl_2018_wjetsnode.root
rm /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/fitdiag2/fitDiagnostics_shapes_combine_hadd_sl_2018_stnode.root
rm /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/fitdiag2/fitDiagnostics_shapes_combine_hadd_sl_2018_othernode.root
rm /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/fitdiag2/fitDiagnostics_shapes_combine_hadd_sl_2018_ttnode.root
rm /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/fitdiag2/fitDiagnostics_shapes_combine_hadd_sl_2018_Hnode.root

"""
list_plots = [
    [
        "wjetsnode",
        [ "all_resolved_1b_sr_dnn_node_wjets", "all_resolved_2b_sr_dnn_node_wjets", "all_boosted_sr_dnn_node_wjets",], # name of bin
        "[ ['res 1b'], ['res 2b'], ['boosted']]", #                   # label to write on plot, comas in the inner brackets will make new lines
        "[2, 13, 23]",                       # x-position of that label
        "Wjets node"              # label of plot (can be latex)
    ],
    [
        "stnode",
        ["all_resolved_1b_sr_dnn_node_st", "all_resolved_2b_sr_dnn_node_st", "all_boosted_sr_dnn_node_st"], # ,
    ...
    [
        "othernode",
        ["all_resolved_1b_sr_dnn_node_class_other", "all_resolved_2b_sr_dnn_node_class_other", "all_boosted_sr_dnn_node_class_other",], #
        "[ ['res 1b'], ['res 2b'], ['boosted']]", # ,
        "[2, 13, 23]",                       # x-position of that label
    ...
    [
        "ttnode",
        ["all_resolved_1b_sr_dnn_node_tt", "all_resolved_2b_sr_dnn_node_tt", "all_boosted_sr_dnn_node_tt",], #
        "[['res 1b'], ['res 2b'], ['boosted']]", # ,
        "[2, 13, 23]",                       # x-position of that label
