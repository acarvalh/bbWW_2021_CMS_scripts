...
#
"""
python make_DL_dict.py \
--fitdiag_folder /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/fitdiag2  \
--output_dict /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/plots2/dict_DL.dat \
--only_sig

/afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/plots/dict_DL.dat

python dhi/scripts/postfit_plots.py \
--output_folder /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/plots2/DL/ \
--plot_options_dict /afs/cern.ch/work/a/acarvalh/public/to_HH_bbWW/freze2_March19/round1/plots2/dict_DL.dat
...
for teste_class in list_plots :
    for era in [ "2016"] : # "2016", "2017",
        ...
        for bin in teste_class[1] :
            ...
            -- sl
            fitDiagnostics_shapes_combine_sl_2018_all_boosted_1b_sr_dnn_node_class_HHVBF_NLO.root
            fitDiagnostics_shapes_combine_sl_2018_all_boosted_1b_sr_dnn_node_class_HHGluGlu_NLO.root
            fitDiagnostics_shapes_combine_sl_2017_all_boosted_1b_sr_dnn_node_class_HHVBF_NLO.root
            fitDiagnostics_shapes_combine_sl_2017_all_boosted_1b_sr_dnn_node_class_HHGluGlu_NLO.root

            fitDiagnostics_shapes_combine_sl_2017_all_resolved_1b_sr_dnn_node_class_HHGluGlu_NLO.root
            fitDiagnostics_shapes_combine_sl_2018_all_resolved_2b_sr_dnn_node_class_HHGluGlu_NLO.root

            fitDiagnostics_shapes_combine_sl_2017_all_resolved_2b_sr_dnn_node_class_HHVBF_NLO.root
            fitDiagnostics_shapes_combine_sl_2018_all_resolved_1b_sr_dnn_node_class_HHVBF_NLO.root
        ...
        # fitDiagnostics_shapes_combine_dl_2017_all_incl_sr_type2_other.root
