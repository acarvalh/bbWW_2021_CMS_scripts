...
#
"""
python make_SL_dict_TLL.py \
--fitdiag_folder /eos/user/a/acarvalh/bbWW_fullRun2_results/round3_results/prefit_plots/DL_TLL/fitdiag/  \
--output_dict /eos/user/a/acarvalh/bbWW_fullRun2_results/round3_results/prefit_plots/DL_TLL/dict_SL_sig.dat \
--only_sig --only_chanel sl

python dhi/scripts/postfit_plots.py \
--output_folder /eos/user/a/acarvalh/bbWW_fullRun2_results/round3_results/prefit_plots/DL_TLL/plots/SL/ \
--plot_options_dict /eos/user/a/acarvalh/bbWW_fullRun2_results/round3_results/prefit_plots/DL_TLL/dict_SL_sig.dat

-----

python make_SL_dict_TLL.py \
--fitdiag_folder /eos/user/a/acarvalh/bbWW_fullRun2_results/round3_results/prefit_plots/DL_TLL/fitdiag/  \
--output_dict /eos/user/a/acarvalh/bbWW_fullRun2_results/round3_results/prefit_plots/DL_TLL/dict_DL_sig.dat \
--only_sig --only_chanel dl

python dhi/scripts/postfit_plots.py \
--output_folder /eos/user/a/acarvalh/bbWW_fullRun2_results/round3_results/prefit_plots/DL_TLL/plots/DL/ \
--plot_options_dict /eos/user/a/acarvalh/bbWW_fullRun2_results/round3_results/prefit_plots/DL_TLL/dict_DL_sig.dat
